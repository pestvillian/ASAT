...
//    while (ITM_TCR & ITM_TCR_BUSY);  // Wait until ITM is not busy
//    ITM_STIMx[0] = c;  // Send character to ITM stimulus register 0
//}
//
//int _write(int file, char *data, int len) {
//    for (int i = 0; i < len; i++) {
//        ITM_SendChar(data[i]);  // Send the character via ITM
//    }
//    return len;
//}
/* USER CODE END 4 */
